...
" Default Colors
if has("gui_running")
  hi Normal       guifg=#eeeeee   guibg=#0f0f0f
  hi NonText      guifg=#444444   guibg=#0f0f0f
else
...
" Window Elements
hi StatusLine   guifg=#ffffff   guibg=#000b2e   gui=bold
...
hi CursorLine   guibg=#101010 cterm=NONE
...
hi Comment      guifg=#55b0bb                   gui=None
...
hi pythonFunction   guifg=#f8ff35
hi pythonClass      guifg=#ff0086               gui=bold
hi pythonSelf                                   gui=bold
hi pythonConstants  guifg=#aef2ff
